...
- **Signing algorithms** — `ValidAlgorithms` on the resolved tenant config pins which algorithms are accepted. Left null, any algorithm the tenant's published keys support is accepted.
